      ...
      <div className='form-verify-container'>
        ...
        {!showOtpInput ? (
          <form onSubmit={handleEmailSubmit} className='form-verify'>
            ...
            />
            <button type="submit" className='send-button' style={{width:'100%',marginTop:'35px',marginBottom:'10px'}}><p>Gửi</p></button>
          </form>
        ) : (
          <form onSubmit={handleOtpSubmit} className='form-verify'>
            ...
            />
            <button type="submit" className='send-button' style={{width:'100%',marginTop:'35px',marginBottom:'10px'}}><p>Xác thực</p></button>
          </form>
        )}
        <div className='bottom-main'>
          <a href='/login' style={{display:'flex',flexDirection:'row',alignItems:'center'}}>
            <p>Quay lại login ?</p>
