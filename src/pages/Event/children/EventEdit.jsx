import { Form, DatePicker, Input, Image, Upload, Button, Result } from "antd"
...
const EventEdit = () => {
    ...
    }, [form, imageFile, updateImage, event.id, accessToken, navigate])
                    ...
                    <div className="justify-center flex flex-col w-4/5">
                        {showResult ? (
                            <Result
                                className=" pb-40"
                                status="success"
                                title="Event is Successfully Updated"
                                subTitle="You can check out the updated event in the Event page"
                            />
                        ) : (
                            <Form form={form}>
                                ...
                                <Form.Item>
                                    <div className="flex my-10 w-4/5 justify-end gap-10 mx-14">
                                        <button
                                            onClick={handleSave}
                                            className={`hover:scale-110 w-28  shadow-xl relative rounded pl-4 py-2.5 overflow-hidden group bg-green-500 hover:bg-gradient-to-r hover:from-green-500 hover:to-green-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-green-400 transition-all ease-out duration-300 ${
                                                confirmLoading
                                        ...
                                        <button
                                            onClick={handleCancelClick}
                                            className="relative hover:scale-110 shadow-md rounded px-4 py-2.5 overflow-hidden group bg-white hover:bg-gradient-to-r  text-white hover:ring-2 hover:ring-offset-2 hover:ring-slate-400 transition-all ease-out duration-300"
                                        >
